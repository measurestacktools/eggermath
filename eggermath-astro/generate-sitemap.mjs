...
const contentPages = [
  ...
  { path: '/gba-bios', priority: '0.8', changefreq: 'monthly' },
  { path: '/gba-emulator-pc', priority: '0.8', changefreq: 'monthly' },
  { path: '/gbc-games', priority: '0.8', changefreq: 'monthly' },
  { path: '/game-boy-games', priority: '0.8', changefreq: 'monthly' },
